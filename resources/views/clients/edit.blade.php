                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Editar informaçôes do cliente') }}</h3>
                            </div>
                        ...
                        <form method="post" action="{{ route('clients.update', $client) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name', $client->name) }}" required autofocus>
                                ...
                                <div class="row">
                                    <div class="col-1">
                                        ...
                                        <select name="document_type" id="input-document_type" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" required>
                                            @foreach (['RG', 'CPF'] as $document_type)
                                    ...
                                    <div class="col">
                                        <label class="form-control-label" for="input-document_id">{{ __('Nº de Documento') }}</label>
                                        <input type="text" name="document_id" id="input-document_id" class="form-control form-control-alternative{{ $errors->has('document_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Nº de Documento') }}" value="{{ old('document_id', $client->document_id) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-phone">{{ __('Nº de Telefone') }}</label>
                                    <input type="text" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('Nº de Telefone') }}" value="{{ old('phone', $client->phone) }}" required>
