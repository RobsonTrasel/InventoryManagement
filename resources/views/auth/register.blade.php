                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" placeholder="Confime a senha">
                        </div>
                        <div class="form-check text-left {{ $errors->has('password') ? ' has-danger' : '' }}">
                            <label class="form-check-label">
                                ...
                                Eu confirmo que eu sou humano
                                @include('alerts.feedback', ['field' => 'agree_terms_and_conditions'])
                            </label>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-round btn-lg">Cadastrar-se</button>
                    </div>
                </form>
            </div>
        </div>
